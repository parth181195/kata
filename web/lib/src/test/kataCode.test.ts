...
describe('kataCode encode (TS port)', () => {
  it('README Kodachrome matches the Dart codec', () => {
    ...
    })).toBe('kata1:CC,DR400,WBD/+2-5,H-1,S+0.5,C+2,SH-2,NR-4,GR-WS,CCR-W,CCB-O;n=Kodachrome+64;a=Fuji+X+Weekly;v=xt4');
  });
  it('kelvin + mono extras', () => {
    ...
    } as never)).toMatch(/^kata1:ACR,DR200,DP-W,WB5800\/\+0-3,H\+2,S\+3,NR-2,CL-2,GR-SL,MW\+2,MM-1,EC-0\.67;n=Mono\+Push;v=xt5,gfx;u=/);
  });
  it('defaults omitted', () => {
