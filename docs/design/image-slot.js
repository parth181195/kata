...
(() => {
  ...
  const UNSPLASH_HOMEPAGE_HREF =
    'https://unsplash.com/?utm_source=kata_design&utm_medium=referral';
  ...
  const withReferral = (href) => {
    try {
      ...
      if (!u.searchParams.has('utm_source')) {
        u.searchParams.set('utm_source', 'kata_design');
      }
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // (the design tool wrote it into the HTML) so it passes through unchanged.
