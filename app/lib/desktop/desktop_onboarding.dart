    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      Expanded(
        child: ListView.builder(
          // no side padding: a selected row is a white block, and it should run to the
          // window edge rather than stopping short of it
          itemCount: bodies.length,
          itemBuilder: (_, i) {
            final b = bodies[i];
            return KataListRow(
              contentInset: 48, // text keeps the page's alignment; the ground runs edge to edge
